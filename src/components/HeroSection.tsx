      ...
      <div className="container mx-auto px-8 relative z-10">
        <div className="text-center max-w-6xl mx-auto">
          ...
          <div className="bg-surface shadow-elevation-1 rounded-full px-8 py-4 inline-flex items-center mb-8 animate-float">
            ...
            <span className="text-primary font-semibold text-lg">EcoAI Pro - Sustainable Intelligence</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-20">
            ...
            <Button 
              variant="outline" 
              size="lg"
              className="border-2 border-primary/20 hover:bg-primary/5 hover:border-primary px-10 py-5 text-xl font-semibold rounded-full transition-all duration-300"
            >
              Watch Full Demo
            </Button>
          </div>
